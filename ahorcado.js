...
var listaPalabrasSecretas=["PERLA","VALOR","OJERAS","PRIMATE","TECLADO","HELADO","PELOTA","COMETA","RADIO","RELOJ"];
...
function validarPalabra(palabra) {
    ...
    for (let i = 0; i < palabra.length; i++) {
        ...
        if( !(codigo > 64 && codigo < 91) || palabra.trim().length == 0) {
            alert("Por favor no ingrese palabras con acento o caracteres especiales o números");
            exito = false;
            break;
        }
    }
